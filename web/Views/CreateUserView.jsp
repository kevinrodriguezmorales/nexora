<%-- 
    ...
    Created on : 11 may. 2025, 3:38:16 p. m.
    Author     : kevin
--%>
            ...
            <form action="Controller?menu=ListUsersView&action=ListUsers" method="POST">
                <div class="inner-header header-sticky">
                    <div class="secondary-container flex-container full-width flex-justify-between">
                        <h2 class="headline-2">Crear usuario</h2>
                        <button class="button elevated-button" type="submit" name="action" value="CreateUser">Guardar empleado</button>
                    </div>
                </div>
